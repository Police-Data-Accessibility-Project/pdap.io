export const TEST_IDS = {
  ...
  // Typeahead
  typeahead_wrapper: 'typeahead-wrapper',
  typeahead_list: 'typeahead-list',
  typeahead_list_item: 'typeahead-list-item',
  typeahead_list_not_found: 'typeahead-list-not-found',

  // Search Page
  search_form: 'search-form',
  data_source_map: 'data-source-map',
