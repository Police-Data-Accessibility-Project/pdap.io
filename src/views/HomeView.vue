<template>
	  ...
	  <div class="col-span-full"> 
		...
		<p>
		  ...
		  <a href="https://airtable.com/shrbFfWk6fjzGnNsk">
			Make a request <FontAwesomeIcon :icon="faExternalLink" />
		  </a>
		</p>
	  </div>
	...
	<div class="pdap-grid-container pdap-grid-container-columns-2 pt-0 text-xl mb-12 mt-0">
	  <h2 class="col-span-full">
		<FontAwesomeIcon :icon="faSitemap" /> Consolidating records about the Allegheny County Jail
	  </h2>
  ...
  export default {
	...
	mounted: async function() {
	  const dataRequests = await (await fetch(`https://api.airtable.com/v0/app473MWXVJVaD7Es/Data%20Requests?filterByFormula=%28%7Bstatus%20%28deprecated%29%7D%3D%27Complete%27%29`, { 
		method: 'GET',
		headers: headers
	  })).json();
