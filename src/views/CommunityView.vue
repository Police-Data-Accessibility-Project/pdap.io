<template>
	<section class="pdap-grid-container px-4 md:px-8">
		...
		<div class="col-span-full">
			<h2>
				<FontAwesomeIcon :icon="faCodeFork" /> Merged Pull Requests
			</h2>
			<p>We have merged <strong>{{ mergeCount }} pull requests</strong> across <strong>{{ repoCount }}
					repositories</strong>.</p>
			<a href="https://github.com/orgs/Police-Data-Accessibility-Project/projects/25/views/1">
				<FontAwesomeIcon :icon="faExternalLink" /> Good first issues
			</a>
		</div>
		<div class="text-xl hyphens-auto" lang="en">
			<h3>
				<FontAwesomeIcon :icon="faMap" aria-hidden="true" /> Locate sources
			</h3>
			<p>
		...
		<div class="text-xl hyphens-auto" lang="en">
			<h3>
				<FontAwesomeIcon :icon="faEyeSlash" /> Research
			</h3>
			<p>
				Many useful public records can't be easily found online. We work with local experts and request records
				from
