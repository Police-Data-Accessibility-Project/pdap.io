...
<!-- <Suspense> -->
	  <template v-if="dataLoaded">
		<div class="col-span-full">
		  <h2><FontAwesomeIcon :icon="faGlobe" /> Geographic Coverage</h2>
		  <p>
		  ...
		  <a href="https://data-sources.pdap.io"><FontAwesomeIcon :icon="faExternalLink" /> Explore the data</a>
		</div>
	  </template>
	  <template v-if="!dataLoaded">
