<template>
  <section class="pdap-grid-container px-4 md:px-8">
    ...
    <div class="col-span-full">
      <p>
        We
        <strong>locate, describe, and share</strong>
        sources of data about police agencies across the United States, which
        are
        <a
      ...
      <p>
        Criminal legal systems in the United States are decentralized, and
        managed locally. In response, we facilitate local research and
        organizing to keep the data in context. The goal is a
  ...
  <section
    ...
    <div>
      ...
      policies. Fragile URLs are turned into lasting resources for future use.
    </div>
    <div>
      We're
      <a
      ...
      research are possible? What does model transparency look like?
    </div>
  </section>
</template>
