...
if [[ "$GITHUB_EVENT_NAME" == "workflow_dispatch" ]]; then
  ...
  if [[ -n "$API_URL" ]]; then
    ...
    echo "VITE_SM_API_URL=https://source-collector.pdap.io" >> $GITHUB_ENV
    ...
    echo "VITE_SM_API_URL=https://source-collector-app-stage-eqjje.ondigitalocean.app" >> $GITHUB_ENV
  fi
else
